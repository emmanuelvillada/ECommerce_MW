...
namespace ECommerce_MW.Services
{
    public class AzureBlobHelper : IAzureBlobHelper
    {
        ...
        {
            //Así capturo mi ConnString de mi Azure Blob desde el appsettings.json
            string keys = configuration["Blob:AzureStorage"];

            //Con esta propiedad enviando mi conn string, podré acceder a mi blob strorage de azure.
